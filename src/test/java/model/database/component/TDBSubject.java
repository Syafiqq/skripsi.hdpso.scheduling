 ...
 * Name         : syafiq
 * Date / Time  : 25 October 2016, 11:12 PM.
 * Email        : syafiq.rezpector@gmail.com
 * Github       : syafiqq
 */
@SuppressWarnings("unchecked") public class TDBSubject
{
    @Test public void test_001()
    {
        ...
        final DBSubject                   subject_1 = new DBSubject(1, "SPK", "TIF00000", school);
        ObjectList<ObjectList<DBTimeOff>> a         = subject_1.getTimeoff().getAvailabilities();
