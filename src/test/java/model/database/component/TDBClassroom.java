 ...
 * Name         : syafiq
 * Date / Time  : 25 October 2016, 8:13 AM.
 * Email        : syafiq.rezpector@gmail.com
 * Github       : syafiqq
 */
@SuppressWarnings("unchecked") public class TDBClassroom
{
    @Test public void test_001()
    {
        ...
        ObjectList<ObjectList<DBTimeOff>> a           = classroom_1.getTimeoff().getAvailabilities();
