...
@SuppressWarnings({"WeakerAccess", "unused"}) public class DBProblemLoader extends DBComponent
{
    ...
    private void generateSchoolTimeDistribution()
    {
        try
        {
            ...
            final Int2IntLinkedOpenHashMap time_distribution = this.time_distribution;
    ...
    private void generateLessons()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBLesson> lessons = this.lessons;
    ...
    @SuppressWarnings({"Duplicates", "unchecked"}) private void generateSubjects()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBSubject> subjects = this.subjects;
    ...
    @SuppressWarnings({"Duplicates", "unchecked"}) private void generateLecturers()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBLecture> lecturers = this.lecturers;
    ...
    @SuppressWarnings({"Duplicates", "unchecked"}) private void generateClassroom()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBClassroom> classrooms = this.classrooms;
    ...
    @SuppressWarnings({"Duplicates", "unchecked"}) private void generateClasses()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBClass> classes = this.classes;
    ...
    private void generateAvailabilities()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBAvailability> availabilities = this.availabilities;
    ...
    private void generateActivePeriods()
    {
        try
        {
            ...
            Int2ObjectLinkedOpenHashMap<DBPeriod> periods = this.periods;
    ...
    private void generateActiveDays()
    {
        try
        {
            ...
            final Int2ObjectLinkedOpenHashMap<DBDay> days = this.days;
    ...
    public Int2ObjectLinkedOpenHashMap<DBDay> getDays()
    {
        return this.days;
    }

    public Int2ObjectLinkedOpenHashMap<DBPeriod> getPeriods()
    {
        return this.periods;
    }

    public Int2ObjectLinkedOpenHashMap<DBAvailability> getAvailabilities()
    {
        return this.availabilities;
    }

    public Int2ObjectLinkedOpenHashMap<DBClass> getClasses()
    {
        return this.classes;
    }

    public Int2ObjectLinkedOpenHashMap<DBClassroom> getClassrooms()
    {
        return this.classrooms;
    }

    public Int2ObjectLinkedOpenHashMap<DBLecture> getLecturers()
    {
        return this.lecturers;
    }

    public Int2ObjectLinkedOpenHashMap<DBSubject> getSubjects()
    {
        return this.subjects;
    }

    public Int2ObjectLinkedOpenHashMap<DBLesson> getLessons()
    {
        return this.lessons;
    }
