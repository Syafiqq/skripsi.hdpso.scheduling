 ...
 * Name         : syafiq
 * Date / Time  : 15 November 2016, 6:31 PM.
 * Email        : syafiq.rezpector@gmail.com
 * Github       : syafiqq
 */
public class TVelocity_MultiplicationVelocity
{
    ...
    private void test_multiplication_empty_bw__1_0()
    {
        ...
        System.out.printf("Less than -1 {%f}\n", val);
        this.calculate(val);
    }
    ...
    private void test_multiplication_empty_lt__1()
    {
        ...
        System.out.printf("Between -1 and 0 {%f}\n", val);
        this.calculate(val);
    }
    ...
    private void test_multiplication_empty_bw_0_1()
    {
        ...
        System.out.printf("Between 0 and 1 {%f}\n", val);
        this.calculate(val);
    }
    ...
    private void test_multiplication_empty_ht_1()
    {
        ...
        System.out.printf("Higher than 1 {%f}\n", val);
        this.calculate(val);
    }
