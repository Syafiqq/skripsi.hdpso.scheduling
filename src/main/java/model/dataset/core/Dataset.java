...
@SuppressWarnings({"FieldCanBeLocal", "unused"}) public class Dataset
{
    ...
    {
        final int lesson_cluster_length = this.lesson_cluster.length;
        ...
        return new DSScheduleShufflingProperty(day_set, lesson_null_set, classroom_set, lesson_set, lesson_appender_manager, IntArrays.copy(this.time_distribution));
    }
}
